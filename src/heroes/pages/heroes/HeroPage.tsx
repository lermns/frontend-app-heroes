...
export function HeroPage() {
  ...
  const totalPower =
    (heroData?.strength ?? 1) +
    (heroData?.intelligence ?? 1) +
    (heroData?.speed ?? 1) +
    (heroData?.durability ?? 1);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={(heroData?.intelligence ?? 1) * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={(heroData?.durability ?? 1) * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-semibold">
                      {new Date().getFullYear() -
                        Number.parseInt(
                          heroData?.firstAppearance ?? "error"
                        )}{" "}
                      años
                    </span>
                  </div>
