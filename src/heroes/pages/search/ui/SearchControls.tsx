...
export const SearchControls = () => {
  ...
  const strength = parseInt(searchParams.get("strength") ?? "0");

  const setQueryParams = (name: string, value: string) => {
    setSearchParams((prev) => {
      // esto evita bugs usando varios params o en distintos navegadores, ya que se renderiza la web
      // cuando params detecta un nuevo objeto por referencia
  ...
  return (
    <>
          ...
          <Button
            ...
            onClick={() => {
              if (activeAccordion === "advance-filters") {
                setQueryParams("active-accordion", "none");
                return;
              }
      ...
      {/* Advanced Filters */}
      {/* Accordion ui, cuando el value de Accordion coincide con el de AccordionItem este se desplega */}
      <Accordion
        type="single"
        collapsible
